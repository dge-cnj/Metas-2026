...
iniciarFlags <- function(path, aux, i) {
    ...
    pre_processual <- pre_processual %>% 
        ...
        select(
            c(id_processo, sigla_tribunal, sigla_grau, procedimento, recurso, id_tribunal, numero_sigilo, id_ultimo_oj,
              dt_recebimento, data_total_primeira_baixa, dt_pendente_liquido, data_total_inicio_ultimo_pendente_liquido, dt_dessobrestamento, dt_julgamento, dt_julgamento_movimento,
              ...
              data_total_ultimo_pendente, data_total_ultima_suspensao, ramo_justica, id_ultima_classe, dt_pendente, data_ultima_movimentacao, dt_primeira_medida_protetiva_meta, flag_quilombolas, flag_indigenas,
    ...
    part <- part %>% 
        select(
            c(id_processo, sigla_tribunal, sigla_grau, procedimento, recurso, id_tribunal, numero_sigilo, id_ultimo_oj,
              dt_recebimento, data_total_primeira_baixa, dt_pendente_liquido, data_total_inicio_ultimo_pendente_liquido, dt_dessobrestamento, dt_pendente, dt_julgamento, dt_julgamento_movimento,
              dt_julgamento_homologatorio, data_total_primeiro_julgamento_sem_pronuncia, dt_primeiro_julgamento_homologatorio, 
              data_total_primeiro_procedimento_resolvido, dt_decisao_movimento, dt_redistribuido_entrada, dt_redistribuido_saida,
              data_total_ultimo_pendente, data_ultima_movimentacao, data_total_ultima_suspensao, ramo_justica, id_ultima_classe,
    ...
    dge <- dge %>% 
        ...
        summarise(
            ...
            data_total_inicio_ultimo_pendente_liquido = max(data_total_inicio_ultimo_pendente_liquido, na.rm = TRUE),
...
iniciarFlagsEleitoral <- function(path, aux, i) {
    ...
    pre_processual <- pre_processual %>% 
        ...
        select(
            c(id_processo, sigla_tribunal, sigla_grau, procedimento, recurso, id_tribunal, numero_sigilo, id_ultimo_oj,
              ...
              dt_julgamento_homologatorio, data_total_primeiro_julgamento_sem_pronuncia, dt_primeiro_julgamento_homologatorio, 
              data_total_primeiro_procedimento_resolvido, dt_decisao_movimento, dt_redistribuido_entrada, dt_redistribuido_saida,
              data_total_ultimo_pendente, data_total_ultima_suspensao, ramo_justica, id_ultima_classe, ano_eleicao, 
    ...
    part <- part %>% 
        select(
            c(id_processo, sigla_tribunal, sigla_grau, procedimento, recurso, id_tribunal, numero_sigilo, id_ultimo_oj,
              dt_recebimento, data_total_primeira_baixa, dt_pendente, dt_pendente_liquido, data_total_inicio_ultimo_pendente_liquido, dt_dessobrestamento, dt_julgamento, data_ultima_movimentacao, dt_julgamento_movimento,
              dt_julgamento_homologatorio, data_total_primeiro_julgamento_sem_pronuncia, dt_primeiro_julgamento_homologatorio, 
              data_total_primeiro_procedimento_resolvido, dt_decisao_movimento, dt_redistribuido_entrada, dt_redistribuido_saida,
              data_total_ultimo_pendente, data_total_ultima_suspensao, ramo_justica, id_ultima_classe, ano_eleicao,
